...
const MainLayout = ({ children, role, setRole }) => {
  return (
    <div className="fixed inset-0 bg-red-100 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-[448px] h-[892px] bg-white relative shadow-2xl rounded-[3rem] border-[8px] border-slate-900 overflow-hidden flex flex-col ring-8 ring-slate-900/5">
